...
import com.soling.media.ui.MediaService
import com.soling.media.ui.RepositoryGetter

class UsbMusicManager(val usbMediaListRepository: UsbMediaListRepository,val playItemRepository: PlayItemRepository) : IUsbMusicManagerImp(), RepositoryGetter {
